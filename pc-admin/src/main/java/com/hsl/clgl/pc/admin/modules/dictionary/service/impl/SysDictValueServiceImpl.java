package com.hsl.clgl.pc.admin.modules.dictionary.service.impl;
...
import com.hsl.clgl.pc.admin.modules.dictionary.dao.SysDictValueDao;
   ...
   @Autowired
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        Page<SysDictValueEntity> page = this.selectPage(
                new Query<SysDictValueEntity>(params).getPage(),wrapper.orderBy(ColumnConstant.ORDERNUM)
        );
